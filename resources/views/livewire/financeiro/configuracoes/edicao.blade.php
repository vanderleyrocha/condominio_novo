        ...
        <form wire:submit="salvar" class="space-y-4">
            <div class="grid gap-4 md:grid-cols-2">
                <div>
                    ...
                    <input type="text" wire:model="nomeCondominio" class="input">
                    @error('nomeCondominio') <p class="error-text text-xs">{{ $message }}</p> @enderror
                </div>
                <div>
                    <label class="label">Taxa de mensalidade padrão (R$)</label>
                    <input type="text" wire:model="taxaMensalidadePadrao" placeholder="0,00" class="input text-right">
                ...
                <div>
                    ...
                    <input type="number" wire:model="anoInicialFiltroPagamentos" class="input">
                ...
                <div>
                    ...
                    <select wire:model="metodoCorrecao" class="input">
