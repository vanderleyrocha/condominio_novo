<div class="space-y-6">
    <div class="card">
        <div class="mb-4 flex flex-wrap items-center justify-between gap-3">
            <h2 class="text-lg font-semibold text-slate-900">Dívidas</h2>
        ...
        <div class="overflow-x-auto">
            <table class="table-modern">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('dividas.imovel', $imoveis[$nome]) }}"
                                   class="btn btn-primary btn-sm">{{ $nome }}</a>
                            </td>
                            @foreach ($anos as $ano)
                                <td class="text-right">
                    ...
                    @empty
                        <tr>
                            <td colspan="{{ count($anos) + 3 }}" class="py-6 text-center text-slate-500">Nenhuma dívida em aberto</td>
                        </tr>
                    @endforelse
                </tbody>
                <tfoot>
