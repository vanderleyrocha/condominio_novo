 ...
 */
class PdfNovoController extends Controller
{
    use AuthorizesRequests;

    public function __construct(private readonly CorrecaoMonetariaNovaService $correcaoService) {}
     ...
     */
    public function reciboPagamento(PagamentoNovo $pagamento): Response
    {
        ...
        $pdf = app('dompdf.wrapper')
            ->loadView('pdf.recibo-pagamento-novo', ['pagamento' => $pagamento])
    ...
    public function despesasPorPeriodo(Request $request): Response
    {
        ...
        $pdf = app('dompdf.wrapper')->loadView('pdf.despesas-periodo-novo', [
            'title' => ConfiguracoesCondominio::nomeCondominio(),
    ...
    public function resumoIntervalo(Request $request): Response
    {
        ...
        $saldo = ResumoFinanceiroNovo::saldoAnterior($de);
        ...
        $pdf = app('dompdf.wrapper')->loadView('pdf.resumo-intervalo-novo', [
            'saldo' => $saldo,
