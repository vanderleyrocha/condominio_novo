...
class EstornarPagamentoNovo
{
     ...
     */
    public function executar(PagamentoNovo $pagamento, array $valoresPorTaxa): PagamentoNovo
    {
        ...
        return DB::transaction(function () use ($pagamento, $valores): PagamentoNovo {
            $estorno = PagamentoNovo::query()->create([
