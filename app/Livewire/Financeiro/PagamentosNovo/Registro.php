 ...
 * idêntica ao legado; persistência via RegistrarPagamentoNovo.
 */
#[Layout('layouts.app')]
class Registro extends Component
{
    ...
    {
        $this->authorize('create', PagamentoNovo::class);
    ...
    public function salvar(RegistrarPagamentoNovo $acao): void
    {
        $this->erro = '';
        $this->validate();
    ...
    {
        return view('livewire.financeiro.pagamentos-novo.registro', [
