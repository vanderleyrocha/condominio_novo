...
/**
 * Controle de acesso (03-modelo-dados.md): admin e sindico gerem taxas —
 * a regra de data de corte do legado foi aposentada com o level_one.
 * `contabilizado` continua exclusivo do admin (RN-08).
 */
